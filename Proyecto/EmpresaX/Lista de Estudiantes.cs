...
namespace EmpresaX
{
    public partial class Lista_de_Estudiantes : Form
    {
        ...
        public Lista_de_Estudiantes()
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM Alumno_Mstr", sqlCon);
        ...
        private void Lista_de_Estudiantes_Load(object sender, EventArgs e)
        {
        ...
        private void BtnBuscarAutor_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sqlCon.Open();
                    SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM Alumno_Mstr WHERE Alumno_Matricula = '" + txtFiltrarAutor.Text.ToString() + "' ", sqlCon);
                    DataTable dtbl = new DataTable();
                    sqlDa.Fill(dtbl);
        ...
        private void Lista_de_Estudiantes_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
